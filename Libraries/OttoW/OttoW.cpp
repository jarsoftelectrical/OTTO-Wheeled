...
void OttoW::init(int YL, int YR, bool load_calibration, int NoiseSensor, int Buzzer, int USTrigger, int USEcho) {
...
//-- OSCILLATORS TRIMS ------------------------------------------//
///////////////////////////////////////////////////////////////////
void OttoW::setTrims(int YL, int YR) {
  servo[0].SetTrim(YL);
  servo[1].SetTrim(YR);
}

void OttoW::saveTrimsOnEEPROM() {
...
///////////////////////////////////////////////////////////////////
void OttoW::_moveServos(int time, int  servo_target[]) {
  ...
  if(getRestState()==true){
    ...
    for (int i = 0; i < 2; i++) servo[i].SetPosition(servo_target[i]); //servo.write(position+_trim);
  }


void OttoW::oscillateServos(int A[2], int O[2], int T, double phase_diff[2], float cycle=1){
...
void OttoW::_execute(int A[2], int O[2], int T, double phase_diff[2], float steps = 1.0){
...
bool OttoW::getRestState(){

    return isOttoResting;
}

void OttoW::setRestState(bool state){
...
//--    T: Period
//---------------------------------------------------------
void OttoW::jump(float steps, int T){
...
//---------------------------------------------------------
void OttoW::walk(float steps, int T, int dir){
...
int homes[2]={80, 100}; //
    _moveServos(100,homes);   //Move the servos in half a second
}
if (dir == -1){
...
//---------------------------------------------------------
void OttoW::turn(float steps, int T, int dir){
...
//---------------------------------------------------------
void OttoW::bend (int steps, int T, int dir){
...
//---------------------------------------------------------
void OttoW::shakeLeg (int steps,int T,int dir){
...
//---------------------------------------------------------
void OttoW::updown(float steps, int T, int h){
...
//---------------------------------------------------------
void OttoW::swing(float steps, int T, int h){
...
//--     h : Amount of swing (from 0 to 50 aprox)
//---------------------------------------------------------
void OttoW::tiptoeSwing(float steps, int T, int h){
...
//---------------------------------------------------------
void OttoW::jitter(float steps, int T, int h){
...
//---------------------------------------------------------
void OttoW::ascendingTurn(float steps, int T, int h){
...
//--    dir: Direction: LEFT / RIGHT
//---------------------------------------------------------
void OttoW::moonwalker(float steps, int T, int h, int dir){
...
//--     dir:  Direction: LEFT / RIGHT
//-----------------------------------------------------------
void OttoW::crusaito(float steps, int T, int h, int dir){
...
//---------------------------------------------------------
void OttoW::flapping(float steps, int T, int h, int dir){
...
double OttoW::getBatteryVoltage(){
...
unsigned long int OttoW::getMouthShape(int number){
...
unsigned long int OttoW::getAnimShape(int anim, int index){
...
void OttoW::putAnimationMouth(unsigned long int aniMouth, int index){

      ledmatrix.writeFull(getAnimShape(aniMouth,index));
}


void OttoW::putMouth(unsigned long int mouth, bool predefined){
...
void OttoW::_tone (float noteFrequency, long noteDuration, int silentDuration){
    ...
    // delay(500);
      ...
      tone(OttoW::pinBuzzer, noteFrequency, noteDuration);
...
void OttoW::bendTones (float initFrequency, float finalFrequency, float prop, long noteDuration, int silentDuration){
...
//void _tone (float noteFrequency, long noteDuration, int silentDuration);
      ...
      _tone(note_A3 ,500, 500);
	_tone(note_A3 ,500, 500);
	_tone(note_A3 ,500, 500);
	_tone(note_F3 ,375, 375);
...
void OttoW::playGesture(int gesture){
